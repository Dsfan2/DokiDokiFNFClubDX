...
{
  public var scoreJunk(default, set):Int = 0;

  function set_scoreJunk(val):Int
  {
  ...
  public function new(x:Float, y:Float, digitCount:Int, scoreJunk:Int = 100)
  {
    super(x, y);

    for (i in 0...digitCount)
    {
      add(new ScoreNum(x + (25 * i), y));
    }

    this.scoreJunk = scoreJunk;
  }
...
class ScoreNum extends FlxSprite
{
  ...
  public function new(x:Float, y:Float)
  {
    ...
    frames = Paths.getSparrowAtlas('results/score-numbers');
