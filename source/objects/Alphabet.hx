...
class AlphaCharacter extends FlxSprite
{
	...
	public function createBoldSymbol(letter:String)
	{
		switch (letter)
		{
			...
			case "@":
				animation.addByPrefix(letter, 'at bold', 24);
			case "#":
				animation.addByPrefix(letter, 'hashtag bold', 24);
			case "$":
				animation.addByPrefix(letter, 'money bold', 24);
			case "%":
				animation.addByPrefix(letter, 'percent bold', 24);
			case "^":
				animation.addByPrefix(letter, 'exponent bold', 24);
			case "&":
				animation.addByPrefix(letter, 'and bold', 24);
			case "*":
				animation.addByPrefix(letter, 'star bold', 24);
			case "(":
				animation.addByPrefix(letter, 'parenth bold', 24);
			case ")":
				animation.addByPrefix(letter, 'end parenth bold', 24);
			case "-":
				animation.addByPrefix(letter, 'minus bold', 24);
			case "_":
				animation.addByPrefix(letter, 'underscore bold', 24);
			case "=":
				animation.addByPrefix(letter, 'equals bold', 24);
			case "+":
				animation.addByPrefix(letter, 'plus bold', 24);
			case "[":
				animation.addByPrefix(letter, 'bracket bold', 24);
			case "]":
				animation.addByPrefix(letter, 'end bracket bold', 24);
			case "{":
				animation.addByPrefix(letter, 'curly brace bold', 24);
			case "}":
				animation.addByPrefix(letter, 'end curly brace bold', 24);
			case '\\':
				animation.addByPrefix(letter, 'backslash bold', 24);
			case '|':
				animation.addByPrefix(letter, 'line bold', 24);
			case ':':
				animation.addByPrefix(letter, 'colon bold', 24);
			case ';':
				animation.addByPrefix(letter, 'semicolon bold', 24);
			case "'":
				animation.addByPrefix(letter, 'apostrophe bold', 24);
			case "\"":
				animation.addByPrefix(letter, 'quote bold', 24);
			case ",":
				animation.addByPrefix(letter, 'comma bold', 24);
			case '.':
				animation.addByPrefix(letter, 'period bold', 24);
			case "<":
				animation.addByPrefix(letter, 'lessthan bold', 24);
			case ">":
				animation.addByPrefix(letter, 'greaterthan bold', 24);
			case '/':
				animation.addByPrefix(letter, 'forwardslash bold', 24);
			case "?":
	...
	public function createSymbol(letter:String)
	{
		switch (letter)
		{
			...
			case "-":
				animation.addByPrefix(letter, 'minus', 24);
			default:
				animation.addByPrefix(letter, letter, 24);
		}
		animation.play(letter);
