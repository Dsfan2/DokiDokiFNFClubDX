...
class ResetScoreSubState extends MusicBeatSubstate
{
	...
	public function new(song:String, difficulty:Int, character:String, week:String = "")
	{
		...
		var tooLong:Float = (name.length > 18) ? 0.8 : 1; //Pecking Winter Horrorlandmmmmmmmmmmmmmmmmm
	...
	override function update(elapsed:Float)
	{
		...
		if(week == "") icon.alpha += elapsed * 2.5;
	...
	function updateOptions() {
		...
		if(week == "") icon.animation.curAnim.curFrame = confirmInt;
	}
}