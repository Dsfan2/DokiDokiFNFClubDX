...
class BaseStage extends FlxBasic
{
	...
	public var isDokiDoki(get, never):Bool;
	...
	public function addToGame(obj:FlxBasic) insert(members.indexOf(game.exGroup), obj);
	...
	inline private function get_freeplayCutscenes() return ClientPrefs.freeplayCutscenes;
	...
	inline private function get_curPlayer() return ClientPrefs.playerChar;
	inline private function get_isDokiDoki() return CoolUtil.difficultyString() == 'DOKI DOKI';
